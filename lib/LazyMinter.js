...
class LazyMinter {
    ...
    * @returns {NFTVoucher}
    */
    async createVoucher(tokenId, sellingPrice = 0, royaltyBasisPoints = 0, tokenUri) {
        const voucher = { tokenId, sellingPrice, royaltyBasisPoints, tokenUri }
        const dataHash = ethers.utils.solidityKeccak256(
            ["uint256", "uint256", "uint16", "string"],
            [tokenId, sellingPrice, royaltyBasisPoints, tokenUri]
        )
